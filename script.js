...
const COMBAT_ANOMALIES = [
    // === ANGEL CARTEL ===
    { name: "Angel Hideaway", faction: "Angel Cartel", difficulty: 1, security: "High", escalation: "No", notes: "Easiest Angel site. Low bounties." },
    { name: "Angel Hidden Hideaway", faction: "Angel Cartel", difficulty: 2, security: "High/Low", escalation: "No", notes: "Level 2 variant with more spawns" },
    { name: "Angel Burrow", faction: "Angel Cartel", difficulty: 2, security: "High/Low", escalation: "Yes", notes: "Can escalate to Angel Mineral Acquisition Outpost (DED 3/10)" },
    { name: "Angel Hidden Burrow", faction: "Angel Cartel", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "Level 2 Burrow variant. Can escalate to DED 4/10" },
    { name: "Angel Forsaken Burrow", faction: "Angel Cartel", difficulty: 3, security: "Low", escalation: "Yes", notes: "Contains elite ships. May escalate to DED 4/10" },
    { name: "Angel Den", faction: "Angel Cartel", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "Medium difficulty. Can escalate." },
    { name: "Angel Hidden Den", faction: "Angel Cartel", difficulty: 4, security: "Low", escalation: "Yes", notes: "Level 2 Den with elite spawns. Can escalate to DED 5/10" },
    { name: "Angel Forsaken Den", faction: "Angel Cartel", difficulty: 4, security: "Low", escalation: "Yes", notes: "Elite variant of Den. May escalate to DED 5/10" },
    { name: "Angel Yard", faction: "Angel Cartel", difficulty: 5, security: "Low/Null", escalation: "Yes", notes: "Lowsec/nullsec site" },
    { name: "Angel Rally Point", faction: "Angel Cartel", difficulty: 5, security: "Low/Null", escalation: "Yes", notes: "Can escalate to DED 5/10 expedition" },
    { name: "Angel Hidden Rally Point", faction: "Angel Cartel", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 2 Rally Point. Can escalate to DED 6/10" },
    { name: "Angel Forsaken Rally Point", faction: "Angel Cartel", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Elite Rally Point variant. May escalate to DED 7/10" },
    { name: "Angel Port", faction: "Angel Cartel", difficulty: 7, security: "Null", escalation: "Yes", notes: "Nullsec only. High difficulty. Can escalate to DED 7/10" },
    { name: "Angel Hub", faction: "Angel Cartel", difficulty: 8, security: "Null", escalation: "Yes", notes: "Nullsec Hub. Good bounties. Can escalate to DED 8/10" },
    { name: "Angel Hidden Hub", faction: "Angel Cartel", difficulty: 8, security: "Null", escalation: "Yes", notes: "Elite Hub variant. May escalate to DED 8/10" },
    { name: "Angel Forsaken Hub", faction: "Angel Cartel", difficulty: 9, security: "Null", escalation: "Yes", notes: "Very hard. Elite battleships. Can escalate to DED 10/10" },
    { name: "Angel Haven", faction: "Angel Cartel", difficulty: 9, security: "Null", escalation: "No", notes: "One of hardest sites. Excellent bounties. Can escalate to DED 10/10" },
    { name: "Angel Sanctum", faction: "Angel Cartel", difficulty: 10, security: "Null", escalation: "No", notes: "Hardest Angel site. Best rewards. Can escalate to DED 10/10" },

    // === BLOOD RAIDERS ===
    { name: "Blood Hideaway", faction: "Blood Raiders", difficulty: 1, security: "High", escalation: "No", notes: "Easiest Blood site" },
    { name: "Blood Hidden Hideaway", faction: "Blood Raiders", difficulty: 2, security: "High/Low", escalation: "No", notes: "Level 2 variant" },
    { name: "Blood Burrow", faction: "Blood Raiders", difficulty: 2, security: "High/Low", escalation: "Yes", notes: "Can escalate to DED 3/10" },
    { name: "Blood Hidden Burrow", faction: "Blood Raiders", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "More spawns than basic Burrow. Can escalate to DED 4/10" },
    { name: "Blood Forsaken Burrow", faction: "Blood Raiders", difficulty: 3, security: "Low", escalation: "Yes", notes: "Elite variant. May escalate to DED 4/10" },
    { name: "Blood Den", faction: "Blood Raiders", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "Medium difficulty. Can escalate to DED 3/10 or 4/10" },
    { name: "Blood Hidden Den", faction: "Blood Raiders", difficulty: 4, security: "Low", escalation: "Yes", notes: "Level 2 Den. Can escalate to DED 5/10" },
    { name: "Blood Forsaken Den", faction: "Blood Raiders", difficulty: 4, security: "Low", escalation: "Yes", notes: "Elite Den with Dark Blood spawns. May escalate to DED 5/10" },
    { name: "Blood Yard", faction: "Blood Raiders", difficulty: 5, security: "Low/Null", escalation: "Yes", notes: "Lowsec/nullsec. Can escalate to DED 5/10" },
    { name: "Blood Rally Point", faction: "Blood Raiders", difficulty: 5, security: "Low/Null", escalation: "Yes", notes: "Can escalate to DED 3/10" },
    { name: "Blood Hidden Rally Point", faction: "Blood Raiders", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 2 Rally Point. Can escalate to DED 6/10" },
    { name: "Blood Forsaken Rally Point", faction: "Blood Raiders", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Elite Rally Point. May escalate to DED 7/10" },
    { name: "Blood Port", faction: "Blood Raiders", difficulty: 7, security: "Null", escalation: "Yes", notes: "Nullsec site. Can escalate to DED 7/10" },
    { name: "Blood Hub", faction: "Blood Raiders", difficulty: 8, security: "Null", escalation: "Yes", notes: "High difficulty nullsec. Can escalate to DED 8/10" },
    { name: "Blood Hidden Hub", faction: "Blood Raiders", difficulty: 8, security: "Null", escalation: "Yes", notes: "Elite Hub. May escalate to DED 8/10" },
    { name: "Blood Forsaken Hub", faction: "Blood Raiders", difficulty: 9, security: "Null", escalation: "Yes", notes: "Very hard Hub. Can escalate to DED 10/10" },
    { name: "Blood Haven", faction: "Blood Raiders", difficulty: 9, security: "Null", escalation: "No", notes: "High-tier ratting site. Can escalate to DED 10/10 (Blood Raider Naval Shipyard)" },
    { name: "Blood Sanctum", faction: "Blood Raiders", difficulty: 10, security: "Null", escalation: "No", notes: "Hardest Blood site. Can escalate to DED 10/10 (Blood Raider Naval Shipyard)" },

    // === GURISTAS ===
    { name: "Guristas Hideaway", faction: "Guristas", difficulty: 1, security: "High", escalation: "No", notes: "Easiest Guristas site" },
    { name: "Guristas Hidden Hideaway", faction: "Guristas", difficulty: 2, security: "High/Low", escalation: "No", notes: "Level 2 variant" },
    { name: "Guristas Burrow", faction: "Guristas", difficulty: 2, security: "High/Low", escalation: "Yes", notes: "Can escalate to DED 3/10" },
    { name: "Guristas Hidden Burrow", faction: "Guristas", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "More spawns. Can escalate to DED 4/10" },
    { name: "Guristas Forsaken Burrow", faction: "Guristas", difficulty: 3, security: "Low", escalation: "Yes", notes: "Elite Burrow. May escalate to DED 4/10" },
    { name: "Guristas Den", faction: "Guristas", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "Medium difficulty. Can escalate to DED 3/10 or 4/10" },
    { name: "Guristas Hidden Den", faction: "Guristas", difficulty: 4, security: "Low", escalation: "Yes", notes: "Level 2 Den. Can escalate to DED 5/10" },
    { name: "Guristas Forsaken Den", faction: "Guristas", difficulty: 4, security: "Low", escalation: "Yes", notes: "Elite Den with Dread Guristas spawns. Can escalate to DED 5/10" },
    { name: "Guristas Yard", faction: "Guristas", difficulty: 5, security: "Low/Null", escalation: "Yes", notes: "Lowsec/nullsec. Can escalate to DED 5/10" },
    { name: "Guristas Rally Point", faction: "Guristas", difficulty: 5, security: "Low/Null", escalation: "Yes", notes: "Can escalate to DED 3/10" },
    { name: "Guristas Hidden Rally Point", faction: "Guristas", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 2 Rally. Can escalate to DED 6/10" },
    { name: "Guristas Forsaken Rally Point", faction: "Guristas", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Elite Rally. May escalate to DED 7/10" },
    { name: "Guristas Port", faction: "Guristas", difficulty: 7, security: "Null", escalation: "Yes", notes: "Nullsec only. Can escalate to DED 7/10" },
    { name: "Guristas Hub", faction: "Guristas", difficulty: 8, security: "Null", escalation: "Yes", notes: "High difficulty. Can escalate to DED 8/10" },
    { name: "Guristas Hidden Hub", faction: "Guristas", difficulty: 8, security: "Null", escalation: "Yes", notes: "Elite Hub. May escalate to DED 8/10" },
    { name: "Guristas Forsaken Hub", faction: "Guristas", difficulty: 9, security: "Null", escalation: "Yes", notes: "Very hard Hub. Can escalate to DED 10/10" },
    { name: "Guristas Haven", faction: "Guristas", difficulty: 9, security: "Null", escalation: "No", notes: "High-tier site. Can escalate to DED 10/10 (Maze)" },
    { name: "Guristas Sanctum", faction: "Guristas", difficulty: 10, security: "Null", escalation: "No", notes: "Hardest Guristas site. Can escalate to DED 10/10 (Maze)" },
