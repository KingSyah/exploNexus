...
const COMBAT_ANOMALIES = [
    ...
    { name: "Angel Sanctum", faction: "Angel Cartel", difficulty: 10, security: "Null", escalation: "No", notes: "Hardest Angel site. Best rewards. Can escalate to DED 10/10 (n/a)" },
    ...
    // === SANSHA'S NATION ===
    { name: "Sansha Hideaway", faction: "Sansha's Nation", difficulty: 1, security: "High", escalation: "No", notes: "Easiest Sansha site. Can escalate to DED 3/10 (Sansha's Command Relay Outpost)" },
    { name: "Sansha Hidden Hideaway", faction: "Sansha's Nation", difficulty: 1, security: "High/Low", escalation: "No", notes: "Level 2 variant" },
    { name: "Sansha Forsaken Hideaway", faction: "Sansha's Nation", difficulty: 1, security: "High/Low", escalation: "No", notes: "Level 3 variant" },
    { name: "Sansha Forlorn Hideaway", faction: "Sansha's Nation", difficulty: 1, security: "High/Low", escalation: "No", notes: "Level 4 variant" },
    { name: "Sansha Burrow", faction: "Sansha's Nation", difficulty: 2, security: "High", escalation: "No", notes: "High Sec Site" },
    { name: "Sansha Refuge", faction: "Sansha's Nation", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "More spawns. Can escalate to DED 3/10 (Sansha's Command Relay Outpost)" },
    { name: "Sansha Den", faction: "Sansha's Nation", difficulty: 4, security: "High/Low", escalation: "Yes", notes: "Medium difficulty. Can escalate to DED 5/10 (Sansha's Nation Neural Paralytic Facility)" },
    { name: "Sansha Hidden Den", faction: "Sansha's Nation", difficulty: 4, security: "Low/Null", escalation: "No", notes: "Level 2 Den" },
    { name: "Sansha Forsaken Den", faction: "Sansha's Nation", difficulty: 4, security: "Low/Null", escalation: "No", notes: "Level 3 Den with True Sansha spawns" },
    { name: "Sansha Forlorn Den", faction: "Sansha's Nation", difficulty: 4, security: "Low/Null", escalation: "No", notes: "Level 4 Den" },
    { name: "Sansha Yard", faction: "Sansha's Nation", difficulty: 5, security: "Low", escalation: "Yes", notes: "Lowsec. Can escalate to DED 6/10 (Sansha War Supply Complex)" },
    { name: "Sansha Rally Point", faction: "Sansha's Nation", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Can escalate to DED 6/10 (Sansha War Supply Complex)" },
    { name: "Sansha Hidden Rally Point", faction: "Sansha's Nation", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 2 Rally. Can escalate to DED 9/10 (True Sansha Fleet Staging Point)" },
    { name: "Sansha Forsaken Rally Point", faction: "Sansha's Nation", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 3 Rally. May escalate to DED 8/10 (Sansha Prison Camp)" },
    { name: "Sansha Forlorn Rally Point", faction: "Sansha's Nation", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 4 Rally. May escalate to DED 8/10 (Sansha Prison Camp)" },
    { name: "Sansha Port", faction: "Sansha's Nation", difficulty: 7, security: "Low/Null", escalation: "Yes", notes: "May escalate to DED 7/10 (Sansha Military Operations Complex)" },
    { name: "Sansha Hub", faction: "Sansha's Nation", difficulty: 8, security: "Low/Null", escalation: "Yes", notes: "May escalate to DED 8/10 (Sansha Prison Camp)" },
    { name: "Sansha Hidden Hub", faction: "Sansha's Nation", difficulty: 8, security: "Low/Null", escalation: "No", notes: "Level 2 Hub" },
    { name: "Sansha Forsaken Hub", faction: "Sansha's Nation", difficulty: 8, security: "Low/Null", escalation: "Yes", notes: "Level 3 Hub. Can escalate to DED 9/10 (True Sansha Fleet Staging Point)" },
    { name: "Sansha Forlorn Hub", faction: "Sansha's Nation", difficulty: 8, security: "Low/Null", escalation: "Yes", notes: "Level 4 Hub. Can escalate to DED 9/10 (True Sansha Fleet Staging Point)" },
    { name: "Sansha Haven", faction: "Sansha's Nation", difficulty: 9, security: "Null", escalation: "Yes", notes: "High-tier site. Can escalate to DED 10/10 (Centus Assembly T.P. Co.)" },
    { name: "Sansha Sanctum", faction: "Sansha's Nation", difficulty: 10, security: "Null", escalation: "Yes", notes: "Hardest Sansha site. Can escalate to DED 10/10 (Centus Assembly T.P. Co.)" },

    // === SERPENTIS ===
    { name: "Serpentis Hideaway", faction: "Serpentis", difficulty: 1, security: "High/Low", escalation: "Yes", notes: "Easiest Serpentis site. Can escalate to DED 3/10 (Serpentis Narcotic Warehouses)" },
    { name: "Serpentis Hidden Hideaway", faction: "Serpentis", difficulty: 1, security: "High/Low", escalation: "No", notes: "Level 2 variant" },
    { name: "Serpentis Forsaken Hideaway", faction: "Serpentis", difficulty: 1, security: "High/Low", escalation: "No", notes: "Level 3 variant" },
    { name: "Serpentis Forlorn Hideaway", faction: "Serpentis", difficulty: 1, security: "High/Low", escalation: "No", notes: "Level 4 variant" },
    { name: "Serpentis Burrow", faction: "Serpentis", difficulty: 2, security: "High", escalation: "No", notes: "High Sec Site" },
    { name: "Serpentis Refuge", faction: "Serpentis", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "More spawns. Can escalate to DED 3/10 (Serpentis Narcotic Warehouses)" },
    { name: "Serpentis Den", faction: "Serpentis", difficulty: 4, security: "High/Low", escalation: "Yes", notes: "Medium difficulty. Can escalate to DED 5/10 (Serpentis Corporation Hydroponics Site)" },
    { name: "Serpentis Hidden Den", faction: "Serpentis", difficulty: 4, security: "Low/Null", escalation: "No", notes: "Level 2 Den" },
    { name: "Serpentis Forsaken Den", faction: "Serpentis", difficulty: 4, security: "Low/Null", escalation: "Yes", notes: "Level 3 Den with Shadow Serpentis spawns. Can escalate to DED 7/10 (Serpentis Paramilitary Complex)" },
    { name: "Serpentis Forlorn Den", faction: "Serpentis", difficulty: 4, security: "Low/Null", escalation: "No", notes: "Level 4 Den" },
    { name: "Serpentis Yard", faction: "Serpentis", difficulty: 5, security: "Low/Null", escalation: "Yes", notes: "Lowsec. Can escalate to DED 6/10 (Serpentis Logistical Outpost)" },
    { name: "Serpentis Rally Point", faction: "Serpentis", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Can escalate to DED 6/10 (Serpentis Logistical Outpost)" },
    { name: "Serpentis Hidden Rally Point", faction: "Serpentis", difficulty: 6, security: "Low/Null", escalation: "No", notes: "Level 2 Rally" },
    { name: "Serpentis Forsaken Rally Point", faction: "Serpentis", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 3 Rally. May escalate to DED 8/10 (Serpentis Prison Camp)" },
    { name: "Serpentis Forlorn Rally Point", faction: "Serpentis", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "Level 4 Rally. May escalate to DED 8/10 (Serpentis Prison Camp)" },
    { name: "Serpentis Port", faction: "Serpentis", difficulty: 7, security: "Low/Null", escalation: "Yes", notes: "Nullsec only. Can escalate to DED 7/10 (Serpentis Paramilitary Complex)" },
    { name: "Serpentis Hub", faction: "Serpentis", difficulty: 8, security: "Low/Null", escalation: "Yes", notes: "High difficulty. Can escalate to DED 8/10 (Serpentis Prison Camp)" },
    { name: "Serpentis Hidden Hub", faction: "Serpentis", difficulty: 8, security: "Null", escalation: "No", notes: "Level 2 Hub" },
    { name: "Serpentis Forsaken Hub", faction: "Serpentis", difficulty: 8, security: "Null", escalation: "Yes", notes: "Level 3 Hub. Can escalate to DED 9/10 (Shadow Serpentis Fleet Staging Point)" },
    { name: "Serpentis Forlorn Hub", faction: "Serpentis", difficulty: 8, security: "Null", escalation: "Yes", notes: "Level 4 Hub. Can escalate to DED 9/10 (Shadow Serpentis Fleet Staging Point)" },
    { name: "Serpentis Haven", faction: "Serpentis", difficulty: 9, security: "Null", escalation: "Yes", notes: "High-tier site. Can escalate to DED 10/10 (Serpentis Fleet Shipyard)" },
    { name: "Serpentis Sanctum", faction: "Serpentis", difficulty: 10, security: "Null", escalation: "Yes", notes: "Hardest Serpentis site. Can escalate to DED 10/10 (Serpentis Fleet Shipyard)" },

    // === ROGUE DRONES ===
    { name: "Drone Cluster", faction: "Rogue Drones", difficulty: 1, security: "High/Low", escalation: "No", notes: "Easiest drone site" },
    { name: "Drone Collection", faction: "Rogue Drones", difficulty: 2, security: "High", escalation: "No", notes: "Low value, skip in highsec" },
    { name: "Drone Assembly", faction: "Rogue Drones", difficulty: 3, security: "High/Low", escalation: "Yes", notes: "Medium difficulty. Can escalate to DED 3/10 (Rogue Drone Asteroid Infestation)" },
    { name: "Drone Gathering", faction: "Rogue Drones", difficulty: 4, security: "High/Low/Null", escalation: "Yes", notes: "Medium difficulty. Can escalate to DED 3/10 (Rogue Drone Asteroid Infestation)" },
    { name: "Drone Surveillance", faction: "Rogue Drones", difficulty: 5, security: "Low", escalation: "Yes", notes: "Medium difficulty. Can escalate to DED 3/10 (Rogue Drone Asteroid Infestation)" },
    { name: "Drone Menagerie", faction: "Rogue Drones", difficulty: 6, security: "Low/Null", escalation: "Yes", notes: "High difficulty Can escalate to DED 5/10 (Outgrowth Rogue Drone Hive)" },
    { name: "Drone Herd", faction: "Rogue Drones", difficulty: 7, security: "Low/Null", escalation: "Yes", notes: "Can escalate to DED 5/10 (Outgrowth Rogue Drone Hive/Drone Infested Starbase)" },
    { name: "Drone Squad", faction: "Rogue Drones", difficulty: 8, security: "Low/Null", escalation: "Yes", notes: "Best drone site for newbro. Can escalate to DED 10/10 (Outgrowth Rogue Drone Hive)" },
